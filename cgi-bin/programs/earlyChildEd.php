...
$page_title="Early Childhood Education";
 ...
 $videoId="";
 $replacementImg="../assets/earlyChildEd/Early1.jpg";
 ...
 $classOneTitle="Child Development/Advanced Child Development";
 ...
 $classTwoTitle="Early Childhood Education I";
 $classTwoInfo="Students enrolled in Early Childhood Education I attend class at the Warren Early Childhood Center. While at the center students will divide their time between classroom instruction and work based learning in a preschool setting.  Students will have the opportunity to earn college credits through Ivy Tech Community College.  While in the preschool classrooms the focus is on developing skills and techniques for providing appropriate environments and care for young children"; 
 $classThreeTitle="Early Childhood Education II";
 ...
 $classFourTitle="";
 $classFourInfo="";
 $galleryImgs=["../assets/earlyChildEd/Early2.jpg","../assets/earlyChildEd/Early3.jpg"];
 ...
 $testimonies=[""];
 $testimoniesName=[""];
 $extraImgs=["../assets/earlyChildEd/Early4.jpg","../assets/earlyChildEd/Early5.jpg"];
 $grade1="Sophomore";
 $grade2="Junior";
 $grade3="Senior";
 $grade4="";
 $teacher1="Mrs. Neyland";
