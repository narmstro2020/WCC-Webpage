...
$page_title="Nursing";
 ...
 $classOneInfo="In Health Science I, you will explore the vast careers within the healthcare profession.  You will build upon your foundation of formal science, natural science, social science and allied science.  You will take the prior information learned and apply it to the human body systems and explore the conditions, diseases and illnesses.  You will begin to speak, write and understand the medical lingo through the teachings of medical terminology taught in Health Science I.";
 $classTwoTitle="Health Science Education II: Nursing";
 $classTwoInfo="Health Science II is the application course.  In HSII you will be introduced to the basic nursing fundamentals through lecture, lab and clinical.  This is your hands on course!  We get to apply all the science knowledge and learn the art of nursing at the bedside in the community caring for the vulnerable population."; 
 $classThreeTitle="";
 $classThreeInfo="";
 $classFourTitle="";
 $classFourInfo="";
 ...
 $prerequisites2="Health Science Education I";
 $prerequisites3="";
 $prerequisites4="";
