...
$page_title="Nursing";
 ...
 $isNewPathway = TRUE;
 $classOneTitle="Year 1 Block";
 $introYearCourseTitle="Principles of Healthcare";
 $introYearCourse2Title="Medical Terminology";
 $classOneInfo="In this first year, you will explore the vast careers within the healthcare profession.  You will build upon your foundation of formal science, natural science, social science and allied science.  You will take the prior information learned and apply it to the human body systems and explore numerous conditions, diseases and illnesses.  You will begin to speak, write and understand medical lingo through the teachings of medical terminology taught in Medical Terminology.";
 $classTwoTitle="Year 2 Block";
 $year1Course1Title="Health Science Education II";
 $year1Course2Title="";
 $year1Info="Health Science II is the application course.  In HSII you will be introduced to the basic nursing fundamentals through lecture, lab and clinical.  This is your hands on course!  We get to apply all the science knowledge and learn the art of nursing at the bedside in the community caring for the vulnerable population.";
 $classThreeTitle="";
 $classThreeInfo="";
 $classFourTitle="";
 $classFourInfo="";
 ...
 $partners=["Provides our locations of Long Term Care to complete our required clinical hours.  Many previous students have secured employment with ASC after completion of course."];
 $partnersImg=["../assets/nursing/partner.png"];
 $partnersName=["American Senior Communities"];
 $dualCredit="Students can earn up to 14 free dual credits in Health Careers: 6 Health Science I and 8 Health Science II: Nursing";
 $dualCreditImg="https://www.ivytech.edu/images/ivy-tech-2015-logo_header.png";
 $dualCreditName="Ivy Tech";
 $internships="We do not have an internship, but rather a required clinical portion we are to meet.  We are required for certification to complete 75 hours of long term care at a long term care facility caring for the vulnerable population.";
 $internshipsImg="";
 $internshipsName="";
 ...
 $grade3="";
 $grade4="";
 $teacher1="Mrs. Lawson/Mrs. Veguilla";
 $teacher2="Mrs. West";
 $teacher3="";
 $teacher4="";
 $prerequisites1="High school science course";
 $prerequisites2="Health Science Year 1";
 $prerequisites3="";
 $prerequisites4="";
