...
$page_title="Electronics";
 ...
 $classTwoTitle="Electronics & Computer Technology I";
 $classTwoInfo="The Electronic Technology program provides instruction and lab activities in electricity and electronics using a hands-on approach combined with computer simulations.
 Analog electronics introduces students to DC and AC electronics, power supplies, magnetism, filters, amplifiers, transistors and solid-state theory. 
 Students will learn about basic electronics, which includes series resistor circuits, parallel resistor circuits, basic house wiring, alarms, schematic understanding, and soldering"; 
 $classThreeTitle="Electronics & Computer Technology II";
 $classThreeInfo="The Electronic Technology program provides instruction and lab activities in electricity and electronics using a hands-on approach combined with computer simulations.
 ...
 $certifications=[["The Associate Certified Electronics Technician (CETa) and the Electronics Service Technicion (EST) from ESPA. ESPA also offers other certifications that are not on the State approved list."]];
 $certificationsImg=["../assets/electronics/cert1.png"];
 $certificationsName=["ESPA"];
 $partners="";
 $partnersImg="";
 $partnersName="";
 $dualCredit="Students can earn up to 12 free dual credits: 3 in Computers Design and Production from Ivy Tech, and 6 in Electronics I and 3 in Electronics II from Vincennes University";
 ...
 $internshipsImg="";
 $internshipsName="";
 $testimonies=["You have the perfect mix of getting down to business and having genuine conversations to better get to know your students. It was thoroughly appreciated.
 Your positive reinforcement was consistent and refreshing.
 There was never a time that any wrong answers given were not explained to us so that we did understand. You know, ACTUALLY teaching students vs just hitting bullet points in a curriculum that you were required to check off.
 Never a day I dreaded coming to your class.","I remember you trying hard not just to give your students the answer to a question. You attempted to teach some critical thinking skills. More importantly, in my job function, I must impart my knowledge to my less experienced colleagues. I try to use “The Griffin Method” to force the junior techs to learn how to ask the right questions so they can get the answer on their own.
