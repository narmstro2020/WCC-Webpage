...
$page_title="Electronics";
 ...
 $partnersImg="";
 $partnersName="";
 $dualCredit="Students can earn up to 12 free dual credits: 3 in Computers Design and Production, 6 in Electronics I and 3 in Electronics II";
 $dualCreditImg="";
 $dualCreditName="Ivy Tech (Computer in Design) & Vincennes";
 $internships="";
 $internshipsImg="";
 $internshipsName="";
