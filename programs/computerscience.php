...
$page_title="Computer Science";
 ...
 $replacementImg="";
 $programOverview="Its a wild week! Computer Science 1 students have finished their first app. CS 2 students are working on their first unit projects. Software devs are creating amazing designs for their apps and our Cyber-security team is busy protecting personal computers. Computer Science, the key to the future.  NOTE TO DEVS: I'd like to maybe put a picture here, off to the side, but don't HAVE to. I'd also maybe like to include a catchy header or Title other than CLASS NEWS.";
 ...
 $certifications=[["This is a place-holder for certifications"]];
 $certificationsImg=["https://www.zubairalexander.com/blog/wp-content/uploads/2019/06/Microsoft_logo_525x525.png"];
 $certificationsName=["Some Agency"];
