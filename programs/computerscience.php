...
$page_title="Computer Science";
 ...
 $certifications="A+, C++, IT";
 $certificationsImg="";
 $certificationsName="Certifying Agency";
 $partners="Nextech provides and oppurtunity for students to take part in a unique paid summer internship called Nextech Catapults. Through this experience, students take a 6 week coding bootcamp, create a portfolio, participate in coding competitions and meet CEO's and Presidents from some of the biggest tech names in Indy.";
 $partnersImg="";
 $partnersName="Nextech";
