...
$page_title="Computer Science";
 ...
 $classOneInfo="In Computer Science 1 you build your own App! This course gives you the foundations of programming using the Code.org platform. In addition to programming, you will explore how the Internet really works, how pictures are sent bit by bit and even dive into Cybersecurity and learn about cryptography and security.";
 $classTwoTitle="Computer Science 2";
 $classTwoInfo="Computer Science 2 builds upon the skills learned in CS 1, but you build software and apps from scratch! Start with a blank, empty programming environment and create whatever your mind can dream up. You will use professional, industry-level software and languages to improve your skills in the foundations and push yourself to more advanced skills. You will dive into Game Design, Native applications and much more!"; 
 $classThreeTitle="Computer Science 3: Software Development";
 $classThreeInfo="Time to put your skills to the test and create a mobile, data-based application for a company or agency. You will follow the Software Development Life Cycle and create an app which will be used in the real-world either in the school or in the community abroad. You will earn the right to call yourself a Developer!";
 $classFourTitle="Computer Science 3: Cybersecurity";
 $classFourInfo="In this PLTW based course, you will explore the world of Cybersecurity. You will learn how to protect personal computers, small LAN networks and larger web-based networks. You will learn how hackers are able to penetrate a system and how to stop them. You will even get to design your own secure network!";
 $galleryImgs=["../assets/cs/images/image1.jpg", "../assets/cs/images/image2.jpg", "../assets/cs/images/image3.jpg", "../assets/cs/images/image4.jpg", "../assets/cs/images/image6.jpg", "../assets/cs/images/image5.jpg", "../assets/cs/images/image7.jpg", "../assets/cs/images/image8.jpg"];
 $certifications="";
 $certificationsImg=[""];
 $certificationsName=[""];
 ...
 $partnersImg=["https://www.sep.com/img/logo-recovery.png"];
 $partnersName=["Software Engineering Professionals"];
 $dualCredit="You can earn 6 credits through Ivy Tech in both Computer Science 1 and Computer Science 2!";
 ...
 $grade3="Senior";
 $grade4="Senior";
 $teacher1="Mr. Law, Mr. Paxson";
 $teacher2="Mr. Law";
 $teacher3="Mr. Law";
 $teacher4="Mr. Law";
 $prerequisites1="";
 $prerequisites2="Computer Science 1";
 $prerequisites3="Computer Science 2";
 $prerequisites4="Computer Science 2";
